...
public class MenuFlipper : MonoBehaviour
{
    public enum PlayerInputNum { Player_1, Player_2, Player_3, Player_4};

    public PlayerInputNum num;

    public enum FlipperTrigger { Left, Right};

    public FlipperTrigger trigger;
    ...
    void FlipperInput()
    {
        ...
        flipperRotation = ((int)trigger < 1 ? PlayerInputManager.Instance.players[1].L_Trigger : PlayerInputManager.Instance.players[1].R_Trigger) * rotMax;
    }
