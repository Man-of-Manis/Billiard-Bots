...
public class CharacterSelection : MonoBehaviour
{
    ...
    void PlayerInput()
    {
        moveLeft = PlayerInputManager.Instance.players[playerInputNum].Movement.x < -deadzone;
        moveRight = PlayerInputManager.Instance.players[playerInputNum].Movement.x > deadzone;
        //lBumper = Input.GetButtonDown(playerInputNum + "_L_Bumper");
        //rBumper = Input.GetButtonDown(playerInputNum + "_R_Bumper");
        accept = PlayerInputManager.Instance.players[playerInputNum].A_Button;
        cancel = PlayerInputManager.Instance.players[playerInputNum].B_Button;
    }
