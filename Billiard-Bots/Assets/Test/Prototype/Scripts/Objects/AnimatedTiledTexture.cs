...
{
    [Tooltip("The object's mesh to be rendered")]
    public Renderer RenderObject;                   // The object that we're rendering
    ...
    private void Start()
    {
        ...
        //{
        //  EditorGUILayout.HelpBox("Gaaaa!", MessageType.Warning);
        //}
    }
    ...
    private void Awake()
    {
        ...
        ChangeMaterial(RenderObject.sharedMaterial, _newMaterialInstance);
    }
    ...
    private void ApplyOffset()
    {
        ...
        // Update the material
        RenderObject.sharedMaterial.SetTextureOffset("_MainTex", offset);
    }
}
